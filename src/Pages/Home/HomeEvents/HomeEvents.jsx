...
const HomeEvents = () => {
  return (
    <section className="my-20">
      <h1 className="text-5xl font-normal border-b-4 w-1/2 text-center pb-10 mx-auto border-black font-serif italic">
        Upcoming Events
      </h1>
      ...
      <div className="flex justify-center ">
        <Link to="/events">
          <button className="flex items-center justify-center w-56 border-[1px] border-black px-8 py-4 hover:bg-black hover:text-white">
            All Events{" "}
